...
def docs_A_get_all(data):
    ...
    contracts = db.collection("Documents").order_by("timestamp", direction="DESCENDING").stream()
    ...
    for contract in contracts:
        ...
        return_value.append({
            ...
            "signed_timestamp": contract_dict.get("signed_timestamp"),
